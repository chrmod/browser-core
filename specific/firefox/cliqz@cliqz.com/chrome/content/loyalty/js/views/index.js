...
//            ]
    ...
    svgs.append("svg:image").attr("xlink:href", function (d) {
      return d['st'] ? d['img'] : ab.im.lock_img;
    })
      .attr("pointer-events", "none")
      .attr("width", function (d) {
        return d.st ? ab.im.w : ab.im.l_w
      })
      .attr("height", function (d) {
        return d.st ? ab.im.h : ab.im.l_h
      })
      .attr("x", (ab.svg.w - ab.im.w) / 2).attr("y", 0);
    svgs.append("svg:text").text(function (d) {
      return d["name"]
    })
    ...
    svgs.append("foreignObject").attr("width", ab.des.w).attr("height", ab.svg.h - ab.im.h_s - ab.des.y0)
      ...
      .append("xhtml:body").attr("class", "award_sub_hide").html(function (d) {
        return d.st ? d["des"] : "(Locked): <br\>" + d["des"];
      });
    ...
    var nAward = ab.data.reduce(function (total, d) {
      return d.st ? total += 1 : total
    }, 0);
  }
};