(function($){
    ...
    function Grid(container,elements,onmove){
        ...
        this.getColumnsAmount = function(){
            return this.columnsSettings(container.innerWidth())
        }

        this.arrange = function(){
            var columns = this.getColumnsAmount(),
                ewidth = Math.floor((container.innerWidth() - (columns - 1) * this.gap) / columns),
                matrix = [],
                maxcelly = 0,
                find = function(){
    ...
    $.fn.grid = function(){
        ...
        if (typeof arguments[0] != "string") {
            ...
            switch(arguments[0]) {
                ...
                case "columns-amount": return container[0].grid.getColumnsAmount(); break;
