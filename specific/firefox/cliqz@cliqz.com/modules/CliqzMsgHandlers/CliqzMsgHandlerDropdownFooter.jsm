...
var CliqzMsgHandlerDropdownFooter = function () {
...
CliqzMsgHandlerDropdownFooter.prototype.constructor =
    CliqzMsgHandlerDropdownFooter;
CliqzMsgHandlerDropdownFooter.prototype.parent =
    CliqzMsgHandler.prototype;
CliqzMsgHandlerDropdownFooter.prototype.registerWindow = function (win) {
...
CliqzMsgHandlerDropdownFooter.prototype.unregisterWindow = function (win) {
...
CliqzMsgHandlerDropdownFooter.prototype._renderMessage = function (message, win) {
...
CliqzMsgHandlerDropdownFooter.prototype._hideMessage = function (message) {
    this._renderMessage(null);
};
// converts message into format expected by UI
CliqzMsgHandlerDropdownFooter.prototype._convertMessage = function (message) {
    var m = {
...
CliqzMsgHandlerDropdownFooter.prototype._addClickListener = function (e) {
    var popup = e.target,
...
CliqzMsgHandlerDropdownFooter.prototype._onClick = function (e) {
