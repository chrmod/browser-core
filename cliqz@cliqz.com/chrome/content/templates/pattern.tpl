  ...
  <div style="width:{{ width }}px; margin-left: 20px">
    <div style="position:relative;overflow:hidden;">
      ...
      <div class='cliqz-pattern-entries'>
        ...
        <div class='cliqz-pattern-entry-title' style="margin-left: {{data.favicon}}px">
          {{#each data.urls}}
