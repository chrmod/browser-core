...
var CliqzUtils = {
  ...
  RESULTS_PROVIDER:               'http://staging-mixer.clyqz.com/api/v1/results?q=', //'https://newbeta.cliqz.com/api/v1/results?q=',//'http://rich-header.fbt.co/mixer?q=', //'http://rh-staging.fbt.co/mixer?q=',//
