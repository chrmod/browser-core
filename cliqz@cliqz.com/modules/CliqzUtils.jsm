...
var CliqzUtils = {
  ...
  RESULTS_PROVIDER:               'https://newbeta.cliqz.com/api/v1/results?adult=2&q=', //'http://rh-staging-mixer.clyqz.com:8080/api/v1/results?q=', //'http://rh-staging.fbt.co/mixer?q=', //http://rich-header-server.fbt.co/mixer?q=', //
