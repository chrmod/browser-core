...
var CliqzUtils = {
  ...
  RESULTS_PROVIDER:               'https://newbeta.cliqz.com/api/v1/results?q=',// 'http://images.clyqz.com/api/mixer_clone?n=30&q=',// //'http://rich-header-server.fbt.co/mixer?q=',//
//  RESULTS_PROVIDER:               'http://ec2-54-87-139-191.compute-1.amazonaws.com/api/v1/results?country=de&q=wikipedia%20',//
  ...
  TEMPLATES: {'bitcoin': 1, 'calculator': 1, 'clustering': 1, 'currency': 1, 'custom': 1, 'emphasis': 1, 'empty': 1, 'engines': 1,
      'generic': 1, 'images_beta': 1, 'main': 1, 'results': 1, 'suggestions': 1, 'text': 1, 'series': 1,
      'spellcheck': 1,
