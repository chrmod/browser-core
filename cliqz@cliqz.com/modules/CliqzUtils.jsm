...
var CliqzUtils = {
  ...
  RESULTS_PROVIDER:               'https://staging-mixer.clyqz.com/api/v1/results?q=', //'http://rich-header.fbt.co/mixer?q=',
  RICH_HEADER:                    'https://staging-mixer.clyqz.com/api/v1/rich-header?path=/map',
