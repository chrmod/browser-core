...
var TEMPLATES_PATH = 'chrome://cliqz/content/templates/',
    ...
    PARTIALS = ['url', 'logo', 'EZ-category', 'EZ-history', 'feedback', 'rd-h3-w-rating', 'pcgame_movie_side_snippet', 'partials/timetable-cinema', 'partials/timetable-movie', 'missing_location'],
    AGO_CEILINGS = [
        [0            , '',                , 1],
        [120          , 'ago1Minute' , 1],
        [3600         , 'agoXMinutes'   , 60],
