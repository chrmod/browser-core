            ...
            return [
                Result.generic(
                    ...
                    null,
                    {
                        ...
                        todayDate: today.getDayOfWeekName() + " " + today.getDate() + CliqzUtils.getLocalizedString('weatherDateSeparator') + today.getMonthName(),
                        todayIcon: WEATHER_ICON_BASE_URL + todayData.weather[0].icon + ".png",
                        tomorrowDay: tomorrow.getDayOfWeekName(),
                        tomorrowDate: tomorrow.getDate()+ CliqzUtils.getLocalizedString('weatherDateSeparator') + tomorrow.getMonthName(),
                        ...
                        aTomorrowDate: aTomorrow.getDate() + CliqzUtils.getLocalizedString('weatherDateSeparator') + aTomorrow.getMonthName(),
