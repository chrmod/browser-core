...
function e(t, n, r) {
    ...
    for (var o = 0; o < r.length; o++) {
      CliqzUtils.log(r.length,"XPXPXPXXP");
      s(r[o]);
    }
    // debugger;
    return s
})({
        1: [function(require, module, exports) {module.exports.RTCSessionDescription = window.RTCSessionDescription ||
...
/* This function is needed to reconnect incase of internet disconnect or flaky situations
* @Konarkm
*/
Peer.prototype.forceDisconnect = function (){
  var self = this;
  // this._cleanup();
  if (!self.disconnected) {
    self.disconnected = true;
