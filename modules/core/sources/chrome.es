// Web Extensions Context Menu Polyfill
// source: https://github.com/mozilla/gecko-dev/blob/master/browser/components/extensions/ext-contextMenus.js
...
// CLIQZ changes start here
var extension = { name: "CLIQZ" };
var context = {};
contextMenuMap.set(extension, new Map());

CliqzEvents.sub('core:chrome:context-menu-showing', menuBuilder.build.bind(menuBuilder));

export default {
  // it is original implementation
  contextMenus: {
