...
var ENGINES = [
    {
        ...
        "code": 3,
        "searchForm": "https://www.google.com/search?q={searchTerms}&ie=utf-8&oe=utf-8",
        "suggestionUrl": "http://suggestqueries.google.com/complete/search?q={searchTerms}&output=firefox&client=firefox",
        "default": true
    },
    {
        "name": "Bing",
        ...
        "code": 5,
        "searchForm": "https://www.bing.com/search?q={sarchTerms}&pc=MOZI",
        "suggestionUrl": "https://www.bing.com/osjson.aspx?query={searchTerms}&form=OSDJAS",
        "default": false
    },
    {
        "name": "Google Images",
        ...
        "code": 1,
        "searchForm": "https://www.google.com/search?tbm=isch&q={searchTerms}",
        "suggestionUrl": "http://suggestqueries.google.com/complete/search?q={searchTerms}&output=firefox&client=firefox",
        "default": false
    },
    {
        ...
        "code": 2,
        "searchForm": "https://maps.google.de/maps?q={searchTerms}",
        "suggestionUrl": "http://suggestqueries.google.com/complete/search?q={searchTerms}&output=firefox&client=firefox",
        "default": false
    },
    {
        ...
        "code": 0,
        "searchForm": "https://duckduckgo.com/?q={searchTerms}&t=ffsb",
        "suggestionUrl": "https://ac.duckduckgo.com/ac/?q={searchTerms}&type=list",
        "default": false
    },
];
...
var CLIQZEnvironment = {
  ...
  getDefaultSearchEngine: function(){
    return CLIQZEnvironment
            .getSearchEngines()
            .filter(function(e){ return e.default == true; })[0];
  },
